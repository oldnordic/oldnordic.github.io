...
## v1.0.0: 14 commands in one day (February 3)
...
The SQLite backend handles everything Mirage needs. The dual-backend experiment was a detour that cost about six weeks across the stack.
...
| CLI commands | 22 (13 analysis + 9 utility) |
| Tests | 474 |
| Commits | 354 |
